...
@Component({
  selector: 'app-firebase-user',
  templateUrl: './firebase-user.component.html',
  styleUrls: ['./firebase-user.component.scss']
})
export class FirebaseUserComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.systemapp = this.authService.getApp("User");
